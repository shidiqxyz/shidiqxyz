...
Saya putuskan untuk membuat blog ini karena terinspirasi dari [lelouch.dev](https://lelouch.dev/). Ceritanya saya saat scrolling twitter ada yang posting thread dari tulisannya ini[^2].
...
Namun, ada hal yang harus dipikirkan terlebih dahulu. Ini cara buat blognya gimana. Apakah menggunakan blogger seperti blog lama saya[^3]? Sepertinya kurang oke, jika menggunakan itu kembali.
...
Ada sekitar satu mingguan Google merilis Google Antygravity[^4]. Saya tahu dari teman dan Fireship[^5]. Sebenarnya ini seperti Cursor[^6] (*another vscode fork*).
